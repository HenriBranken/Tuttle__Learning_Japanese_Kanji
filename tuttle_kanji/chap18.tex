...
% &  \mbox{()}\\\hline
\begin{somme}
\rye{3}{As you can see by the second example, this is another of those 漢字 whose verb form can incorporate its hiragana ending when forming nouns.}
...
Room, Chamber.\\\hline
As they're very similar, make sure not to confuse this character with 屋, the 漢字 for `roof' we learned back in Entry 281.
\end{glyph}
...
% &  \mbox{()}\\\hline
\begin{somme}
\rye{3}{The berbs in the first and second examples below can sometimes absorb their hiragana endings when forming words with other 漢字.}
...
By extension comes the idea of things being correct or corrected (best illustrated by the transitive/instransitive verb pair below).  An important aspect of these two verbs can be seen when they attach to the end of other 漢字 as a suffix (as in the third example).  In such cases, this character gives the compound a sense of `redoing' whater the first 漢字 represents.\\\hline
