...
\rye{3}{These readings always ``double up'' with the onyomi of the 漢字 that follow.  The compounds in which they appear are obscure.}
\end{prons}
...
This 漢字 can also refer to the disciples or pupils of an accomplished master.\\\hline
...
Manner.  Way.  When following a family name, this 漢字 acts as a very polite form of `Mr.', `Mrs.', or `Miss'.
\end{glyph}
