...
Official, government.  This 漢字 is often used as a suffix to indicate an official with some sort of governmental or bureaucratic authority.
\end{glyph}
...
% &  \mbox{()}\\\hline
\begin{somme}
\rye{3}{Recall that the first two 漢字 of the second compound mean `test' or `examination' (from Entry 439), and that the first two 漢字 of the final compound mean `foreign policy' (from Entry 185) when taken together.}
...
Feather.\\\hline
This 漢字 also can also refer to the wings of birds, insects and aeroplanes, etc.
\end{glyph}
...
This odd-looking 漢字 has to do with things `personal', in the sense of someone's own body (as in the first compound) or a specific thing's characteristic (as in the third compound).\\\hline
...
This 漢字 emphasizes the separateness of individual objects (including people).  It is, in fact, used as a general counter for `pieces'---the final compound shows the aspect of this meaning.
\end{glyph}
...
\rye{3}{The kun-yomi can incorporate its ひらがな ending in certain compounds.}
\end{prons}
...
This 漢字 refers to a larger-sized hall, usually in a public building.
\end{glyph}
...
Association, set.  This 漢字 has to do with things coming together or being put together in groups.
\end{glyph}
