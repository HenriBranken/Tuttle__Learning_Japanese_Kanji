...
\begin{remglyph}
\hooglig{Tasting} with your \remcom{mouth} has \remcom{not yet} been approved.\\\hline
\end{remglyph}
...
\rye{3}{{\warn}Ajin are demi-humans in an アニメ series.}
\end{remprons}
...
{\warn}The Shakuhachi is a Japanese (and ancient Chinese) flute made of bamboo.\\\hline
\end{remprons}
