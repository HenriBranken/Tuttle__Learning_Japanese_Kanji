...
表れ&\textit{embodiment; materialisation}&あらわ{\middel}れ \mbox{(arawa{\middel}re)}\\\hline
...
表皮&express + skin = \textit{epidermis; cuticle}&ヒョウ{\middel}ヒ \mbox{(HY\={O}{\middel}HI)}\\\hline
表立つ&express + stand = \textit{to become public / formal / official}&おもて{\middel}だ{\middel}つ \mbox{(omote{\middel}da{\middel}tsu)}\\\hline
表書き&express + write = \textit{address on envelope}&おもて{\middel}が{\middel}き \mbox{(omote{\middel}ga{\middel}ki)}\\\hline
