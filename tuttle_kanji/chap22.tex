...
Court.\\\hline
This 漢字 can refer to \textit{courts of law} (as in the initial two compounds below), and \textit{imperial courts} (as in the last).
\end{glyph}
...
\begin{remglyph}
\hooglig{The court} took \remcom{long strides} for the \remcom{scholars} to wear \remcom{Noh} masks.\\\hline
\end{remglyph}
