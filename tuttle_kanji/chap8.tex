...
Instruction.\\\hline
This 漢字 tends to give a more serious or spiritual sense of ``teaching'' to the compounds in which it appears.
\end{glyph}
...
This 漢字 also serves as the partner to 引 (Entry \ref{glyph:pull}) on door signs.
\end{glyph}
...
{\warn}Nenets is an ethnic group native to Northern Arctic Russia.\\\hline
\end{remprons}
...
Come.\\\hline
As the final four compounds below make clear, the related meanings of ``next'' is also included.
\end{glyph}
...
When used as a suffix, it is often equivalent to the English ``-ology''.  The final compound offers such an example.
\end{glyph}
...
\begin{remglyph}
\hooglig{Study} the \remcom{small} \remcom{crowns} of \remcom{children}.\\\hline
\end{remglyph}
...
Mind.  Thought.\\\hline
This abstract character appears in many compounds conveying the ideas of ``will'', ``intention'', and ``opinion'', etc.
\end{glyph}
...
Again.  Also.\\\hline
A character that rarely appears on its own.\\\hline
...
\begin{sentence}
The pronunciation of 来なかった in this sample sentence, incidentally, is the informal past tense reading of 来.\\\hline
