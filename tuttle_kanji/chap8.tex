...
{\warn}\textit{Chickadees} are a type of North-American bird.\\\hline
\end{remprons}
...
following the 漢字 出, 来 is always read き.}
\end{prons}
...
\rye{3}{The sentence below is an example of the polite past tense.}
\end{somme}
...
\rye{3}{The pronunciation of 来なかった in the sentence below is the informal past tense reading of 来.}
\end{somme}
