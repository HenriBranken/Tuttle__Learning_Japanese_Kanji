...
on-yomi for 分 (Entry \ref{glyph:part}) in the compound 十五分. \\\hline
...
\begin{remglyph}
\hooglig{Spirit} \remcom{men} in the \remcom{steam} room.\\\hline
\end{remglyph}
...
\begin{sentence}
The sample sentence is an extremely common greeting/question in 日本語.\\\hline
...
Time.\\\hline
This character will become familiar to you through its use in the hours of the day (the third and fourth compounds below are examples).
\end{glyph}
...
\begin{remprons}
\hooglig{Time} the \comon{jiggling} \comkun{torque}.\\\hline
\end{remprons}
...
\begin{remprons}
\hooglig{Speak} how \comkun{hung-up} \comkun{Hanah shielded} us from being \comon{washed}.\\\hline
\end{remprons}
...
\begin{remglyph}
\hooglig{Brilliant English} \remcom{grass} is \remcom{central}.\\\hline
\end{remglyph}
