...
\begin{somme}
    ...
    \notyet{最近}  &  most + near = \textit{recently} &  サイ{\middel}キン (SAI{\middel}KIN) \\\hline
\end{somme}
...
\begin{somme}
    ...
    \notyet{馬具}  & horse + tool = \textit{harness}  &  バ{\middel}グ (BA{\middel}GU) \\\hline
\end{somme}
...
\begin{somme}
    ...
    \notyet{来週}  & come + week = \textit{next week}  & ライ{\middel}シュウ (RAI{\middel}SH\={U})  \\\hline
\end{somme}
...
\begin{somme}
    ...
    \notyet{引き受ける}  & pull + receive = \textit{to undertake}  & ひ{\middel}き　う{\middel}ける (hi{\middel}ki u{\middel}keru)  \\\hline
    \notyet{引き上げる}  & pull + upper = \textit{to pull up}  & ひ{\middel}き　あ{\middel}げる (hi{\middel}ki a{\middel}geru)  \\\hline
\end{somme}
...
\begin{somme}
    ...
    \notyet{同時}  & same + time = \textit{simultaneous}  &  ドウ{\middel}ジ (D\={O}{\middel}JI) \\\hline
\end{somme}

\begin{irrr}
    \notyet{時計}  & time + measure = \textit{watch; clock}  & と{\middel}ケイ (to{\middel}KEI)  \\\hline
\end{irrr}
...
\begin{somme}
    ...
    \notyet{注意}  & pour + mind = \textit{attention}  & チュウ{\middel}イ (CH\={U}{\middel}I)  \\\hline
\end{somme}
