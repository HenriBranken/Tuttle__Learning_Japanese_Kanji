...
Road/Way.\\\hline
This interesting 漢字 can signify both a physical road and a spiritual
...
Name.\\\hline
By extension, this 漢字 also includes the ideas of ``reputation'' and ``fame''.
\end{glyph}
...
\pronsrtwocone & \textbf{ヤ (YA)} & \textbf{よる、よ (yoru, yo)}\\\hline
    \rye{3}{よる is onlu used when this 漢字 appears alone.\\\hline
...
% &  ()\\\hline
\begin{somme}
\rye{3}{The third and the firth examples below show that this 漢字 can act like
...
\begin{somme}
    ...
    both 漢字 are read with their 音読み.}
...
Meet/Meeting.\\\hline
When found at the end of compounds, this 漢字 often expresses English words
...
\begin{glyph}{Hear (聞)}{hear}\label{glyph:hear}
    Hear/Ask.  Like 早 (Entry \ref{glyph:early}), this is another 漢字 with two unrelated and
    distinct meanings.
\end{glyph}
...
Center.\\\hline
    Other than the first example (and examples derived from it), this 漢字 is
    rarely used.
\end{glyph}
