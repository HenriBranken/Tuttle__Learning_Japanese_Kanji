...
=\textit{In this country there are a lot of people who really like money.}\\\hline
\end{sentence}
\end{multicols}
\vspace*{\fill}
\pagebreak
...
Meet.  Meeting.\\\hline
When found at the end of compounds, this 漢字 often expresses English words such as ``society'', ``association'', and ``party''.
\end{glyph}
...
Hear.\\\hline
Ask.\\\hline
Like 早 (Entry \ref{glyph:early}), this is another 漢字 with two unrelated and distinct meanings.
\end{glyph}
...
\begin{remglyph}
\hooglig{Hearing} starts at the \remcom{ear} \remcom{gate}.\\\hline
\end{remglyph}
