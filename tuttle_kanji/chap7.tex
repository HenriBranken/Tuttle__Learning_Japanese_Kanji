...
{\warn}Arabesque is a ballet position.  {\warn}Ataraxia is a state of serene calmness.\\\hline
\end{remprons}
...
\begin{remglyph}
\hooglig{Name} the \remcom{evening} \remcom{vampire}.\\\hline
\end{remglyph}
...
Private.\\\hline
This character is also used for the first person singular, ``I''.
\end{glyph}
...
\begin{remglyph}
\hooglig{Night} \remcom{people} feel \remcom{tops} in \remcom{evening} mode.\\\hline
\end{remglyph}
...
\begin{remprons}
    A \hooglig{night}-time \comkun{yomp} to the \comon{yacht} with
