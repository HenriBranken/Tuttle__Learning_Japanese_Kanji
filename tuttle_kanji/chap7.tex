...
Road.  Way.\\\hline
This interesting 漢字 can signify both a physical road and a spiritual ``path''.  In this latter sense, it is often translated as ``the way''.
\end{glyph}
...
This character can indicate both the spiritual sense of heaven as well as the more literal notions of sky and air.
\end{glyph}
...
\begin{somme}
    ...
    In the fourth compound, the 音読み of 王 changes from オウ to ノウ in order
...
This important character suggests the ideas of ``dividing'' and ``portion''.  The sense of ``division'' is always present in some way.\\\hline
The first compound below can be though of as ``parting'' the unknown to arrive at understanding.
\end{glyph}
...
Note also that 大分, one of the many Japanese words expressing the idea of ``much'' or ``very'', can be pronounced ダイブン or ダイブ.}
\end{prons}
...
Thing.  Object.\\\hline
Note that the writing order for ``cow'' differs when it is used as a component; slanting the final stroke upward makes for a smoother transition to the next part of the character.
\end{glyph}
