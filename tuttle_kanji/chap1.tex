...
{\warn}Byakuya and Haku are fictional アニメ characters.\\\hline
\end{remprons}
...
This 漢字 is well-known to Japanese baseball fans as the character used to denote ``innings''.
\end{glyph}
...
回す (tr.) & \textit{to send around (sth)} & まわ{\middel}す \mbox{(mawa{\middel}su)}\\\hline
...
\begin{remglyph}
\hooglig{Four} \remcom{people} danced to the \hooglig{four} corners of the \remcom{enclosure}.\\\hline
\end{remglyph}
