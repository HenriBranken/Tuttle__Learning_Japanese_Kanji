...
\begin{remprons}
\hooglig{Mountainously}, my \comon{son} played a \comkun{yamaha}.\\\hline
\end{remprons}
...
\rye{3}{When this 漢字 appears as the first character in a compound it is almost always read with its 音読み.  \\\hline
    Its pronounciation イチ or イツ will depend on whether the initial sound of the following 漢字 is voiced or voiceless.}
\end{prons}
...
Sun, and Day.\\\hline
It is the initial 漢字 in the compound for "Japan".
\end{glyph}
...
\begin{remprons}
\hooglig{Sun} inspiring \comon{Nichiren} \comon{Ju-Jitsu}; many other
...
White.\\\hline
Shades of cleanliness and purity.
\end{glyph}
...
This 漢字 also relates to openings in general, from caves and harbors to taps and bottles, for instance.
\end{glyph}
...
The general sense of this 漢字 relates to the ideas of rotation and things going around in both space and time.\\\hline
...
Eye.\\\hline
In some instances it is read with its 訓読み, and indicates the ``-th'' suffix in words such as ``fourth'' and ``seventh''; it also expresses the related endings of ``first'', ``second'', ``third'', etc.
\end{glyph}
...
Large.  Big.\\\hline
The meaning of ``important'' and ``great'' (not necessarily always in a positive sense) can also be implied in words containing this 漢字.
\end{glyph}
