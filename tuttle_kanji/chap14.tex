...
Harmony, peace.\\\hline
This 漢字 is also used as an abbreviation for Japan in much the same way 日 is (the final compound offers an example of this usage).
\end{glyph}
...
\rye{3}{You are most likely to encounter ズ in only a pair of words: 頭上 (ズ{\middel}ジョウ/ZU{\middel}J\={O}) \textit{``overhead''}, from the 漢字 `head' and `upper', and the final sample compound of Entry 461.}
\end{prons}
