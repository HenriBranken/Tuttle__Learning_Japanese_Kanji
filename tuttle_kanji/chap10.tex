...
\comprthreecone & Step/Stride + Short Thread + Winter \\\hline
\end{comps}
...
\begin{somme}
    ...
    Chapter 7 (Entry \ref{glyph:before}), to see how the fourth, fifth, and sixth examples
...
% &  ()\\\hline
\begin{somme}
\rye{3}{The third and fourth examples below show this to be another 漢字
...
\comprthreecone & ME (katakana) + Wide open mouth/Container \\\hline
\end{comps}
