...
Dawn.\\\hline
This 漢字 features more often as a component in other 漢字.
\end{glyph}
...
\begin{somme}
    ...
    白黒  & white + black = \textit{black-and-white}  & しら{\middel}くろ \mbox{(shira{\middel}kuro)}  \\\hline
...
\begin{remglyph}
    \hooglig{Mix} up \remcom{father's} \remcom{toppings}.\\\hline
\end{remglyph}
