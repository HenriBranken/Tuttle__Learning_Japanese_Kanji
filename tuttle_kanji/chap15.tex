...
Take care with the stroke order---though the first line of the `merging' component is the initial stroke of this 漢字, the second comes after the three amoebas on the left.  Also keep in mind that the six amoebas are always written left to right.
\end{glyph}
