...
\rye{3}{The kun-yomi is the usual verb stem for the first and second examples below.  A quirk with this 漢字, however, is that you may occasionally see these verbs written as 現われる and 現わす.  Think of these two verbs as things either presenting themselves (in the first instance) or being presented in some way.}
\pronsrthreecone & --- & --- \\\hline
\end{prons}
...
% &  \mbox{()}\\\hline
\begin{somme}
\rye{3}{Note that the second compound uses the less common on-yomi of 土 (ト/TO); this is the only word in which the 漢字 has this reading.  Recall from Entry \ref{glyph:heart} that 心 in the first example below has an irregular reading of ここ/koko.}
