...
When functioning as a component, however, it hints that the 漢字 involved has some connection to metal in general.\index[kanji]{Gold 金}
\end{glyph}
...
Words.\\\hline
This 漢字 will become familiar as the character is used to indicate languages.\index[kanji]{Words 語}
\end{glyph}
...
Gentleman.\\\hline
A man who has attained status in a military or academic field.\index[kanji]{Gentleman 士}
\end{glyph}
...
Morning.\\\hline
A secondary meaning relates to \textit{royal dynasties}.\index[kanji]{Morning 朝}
\end{glyph}
...
The sense of \textit{youth} and \textit{immaturity} is tied up with the idea of green.\index[kanji]{Blue 青}
\end{glyph}
...
Earth as in \textit{dirt}, not the planet.\index[kanji]{Earth 土}
\end{glyph}
...
Hang.\\\hline
Note how the last stroke of the bottom ``earth'' component leads into the next line by being drawn with an upward slant.\index[kanji]{Hang 掛}
\end{glyph}
...
Ten thousand.\\\hline
More so than 百 and 千, this character can express the general idea of \textit{countless amount} of something.\index[kanji]{Ten Thousand 万}
\end{glyph}
...
Electric.  Electricity.\index[kanji]{Electric 電}
\end{glyph}
...
This character never comes first.\index[kanji]{Individual 物}
\end{glyph}
...
Enter.  Putting in.\index[kanji]{Enter 入}
\end{glyph}
...
When used with the 訓読み ま, it can also mean \textit{a room}.\index[kanji]{Interval 間}
\end{glyph}
...
Exit.  Leave.  Let out.\index[kanji]{Exit 出}
\end{glyph}
...
When used as a suffix, it will often indicate \textit{student}.\index[kanji]{Life 生}
\end{glyph}
