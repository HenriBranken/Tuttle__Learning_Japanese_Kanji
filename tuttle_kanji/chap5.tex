...
\begin{remglyph}
Part of the Kanji radicals (\#{51}).\\\hline
\end{remglyph}
...
\begin{somme}
    ...
    日干し & sun + dry = \textit{sun-dried} & ひ　ぼ{\middel}し \mbox{(hi bo{\middel}shi)}\\\hline
...
\begin{remglyph}
\hooglig{Wording} the \remcom{five} \remcom{vampires} \remcom{sayings}.\\\hline
\end{remglyph}
...
\begin{remglyph}
Part of the Kanji radicals (\#{33}).\\\hline
\end{remglyph}
...
\begin{remglyph}
Part of the Kanji radicals (\#{174}).\\\hline
\end{remglyph}
...
\begin{remprons}
\hooglig{Blue} \ucomon{shore} \comon{sailing} really pumps up the \comkun{aorta}.\\\hline
\end{remprons}
...
\begin{remglyph}
Part of the Kanji radicals (\#{32}).\\\hline
\end{remglyph}
...
\begin{remglyph}
    \hooglig{Hanging} \remcom{earth} parcels made by your \remcom{hands} is
    considered to be \remcom{divination}.\\\hline
\end{remglyph}
...
% &  ()\\\hline
\begin{somme}
\rye{3}{As the final example below shows, this kanji can act similarly to 買 (See entry 50).}
...
\comprtwocone & 丨 + 丿 + 一 \\\hline
    \comprthreecone & Pole + NO/Slash + One\\\hline
\end{comps}

\begin{remglyph}
    \hooglig{Ten thousand} \remcom{poles} can be conquered by \remcom{no}
    \remcom{one}.\\\hline
\end{remglyph}
...
\begin{remglyph}
Part of the Kanji radicals (\#{173}).\\\hline
\end{remglyph}
...
\begin{remprons}
    \hooglig{Rain} destroyed the \comon{ooky} \comkun{amalgamation}, and
    therefore \comkun{amends} were not necessary anymore.\\\hline
\end{remprons}
