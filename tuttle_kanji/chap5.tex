...
青白い&blue + white = \textit{pale; pallid}&あお{\middel}じろ{\middel}い \mbox{(ao{\middel}jiro{\middel}i)}\\\hline
...
\notyet{土作り}&earth + make = \textit{keeping soil in good condition}&つち{\middel}づく{\middel}り \mbox{(tsuchi{\middel}zuku{\middel}ri)}\\\hline
\end{somme}
...
\splitter{見掛ける}{tr}&see + hang = \textit{to notice}&み{\middel}か{\middel}ける \mbox{(mi{\middel}ka{\middel}keru)}\\\hline
...
大掛かり&large + hang = \textit{large-scale}&おお{\middel}が{\middel}かり \mbox{(\={o}{\middel}ga{\middel}kari)}\\\hline
\notyet{切っ掛け}&cut + hang = \textit{chance}&きっ{\middel}か{\middel}け \mbox{(kik{\middel}ka{\middel}ke)}\\\hline
\notyet{お出掛け}&exit + hang = \textit{about to start out}&お{\middel}で{\middel}か{\middel}け \mbox{(o{\middel}de{\middel}ka{\middel}ke)}\\\hline
...
\notyet{雨宿り}&rain + lodging = \textit{taking shelter from the rain}&あめ{\middel}やど{\middel}り \mbox{(ame{\middel}yado{\middel}ri)}\\\hline
\end{somme}
