...
%&\mbox{()}\\\hline
\begin{somme}
\specialc{育てる\\(tr.)}&\textit{raise; bring up}&そだ{\middel}てる \mbox{(soda{\middel}teru)}\\\hline
...
%&\mbox{()}\\\hline
\begin{somme}
\specialc{考える\\(tr.)}&\textit{consider; think about}&かんが{\middel}える \mbox{(kanga{\middel}eru)}\\\hline
