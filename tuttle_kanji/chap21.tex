...
% &  \mbox{()}\\\hline
\begin{somme}
\specialc{向ける\\(tr.)}&to turn towards \ldots&む{\middel}ける \mbox{(mu{\middel}keru)}\\\hline
\specialc{向かう\\(intr.)}&\textit{face on; be opposite}&む{\middel}かう \mbox{(mu{\middel}kau)}\\\hline
...
% &  \mbox{()}\\\hline
\begin{somme}
\specialc{練る\\(tr.)}&\textit{to train; knead}&ね{\middel}る \mbox{(ne{\middel}ru)}\\\hline
