...
% &  \mbox{()}\\\hline
\begin{somme}
\specialc{帰る\\(intr.)}&\textit{go back}&かえ{\middel}る \mbox{(kae{\middel}ru)}\\\hline
...
\specialc{持ち帰り\\(tr.)}&hold + homeward = \textit{to bring back}&も{\middel}ち{\middel}かえ{\middel}り \mbox{(mo{\middel}chi{\middel}kae{\middel}ri)}\\\hline
...
\begin{remglyph}
\hooglig{The section} was \remcom{erected} in the \remcom{town}.\\\hline
\end{remglyph}
