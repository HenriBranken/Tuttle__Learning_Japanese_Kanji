...
美学 & beautiful + study = \textit{aesthetics} & ビ{\middel}ガク (BI{\middel}GAKU)\\\hline
\end{somme}

\begin{irrr}
美味しい & beautiful + taste = \textit{delicious} & おい{\middel}しい (oi{\middel}shii)\\\hline	
\end{irrr}
...
\begin{somme}
    ...
    寸前  & tiny + before = \textit{immediately before}  & スン{\middel}ゼン
...
\begin{somme}
    ...
    公開  & public + open = \textit{open to the public}  & コ{\middel}ウカイ (K\={O}{\middel}KAI) \\\hline
\end{somme}
...
\begin{somme}
    ...
    夜鳥  & night + bird = \textit{nocturnal bird}  & ヤ{\middel}チョウ (YA{\middel}CH\={O})  \\\hline
...
\begin{somme}
    ...
    夕立  & evening + stand = \textit{late afternoon (rain) shower}  & ゆう{\middel}だち (y\={u}{\middel}dachi)\\\hline
\end{somme}
...
\begin{somme}
    ...
    海外  & sea + outside = \textit{overseas}  & カイ{\middel}ガイ (KAI{\middel}GAI) \\\hline
\end{somme}
...
\begin{somme}
    ...
    母親  & mother + child = \textit{mother}  &はは{\middel}おや (haha{\middel}oya) \\\hline
...
\begin{somme}
    ...
    秋空  & autumn + empty = \textit{autumn sky}  & あき{\middel}ぞら (aki{\middel}zora)  \\\hline
...
\begin{irrr}
    ...
    切符  & cut + symbol = \textit{ticket}  & きっ{\middel}プ (kip{\middel}pu)  \\\hline
\end{irrr}
