...
\rye{3}{For the general sense of the verb \textit{to go}, いく is used; ゆき is employed far less often and is of most use in a few specific compounds (such as in the second example), or as a suffix meaning \textit{bound for} (as in the third example).}
...
% &  ()\\\hline
\begin{somme}
\rye{3}{The final compound below reminds us once again that this reading of 人 is always voiced when it appears in the second position.}
