...
{\warn}Yoshi is an アニメ　character.\\\hline
\end{remglyph}
...
おおく&の&エイタンゴ&は&ラテンご&に&ユライする\\\hline
...
\begin{remglyph}
\hooglig{Essential} \remcom{western} \remcom{women}.\\\hline
\end{remglyph}
...
\begin{remglyph}
\hooglig{Measure} up to the \remcom{scarecrow's} \remcom{speech}.\\\hline
\end{remglyph}
