...
ls_kanji = [
    ...
    "屋", "各", "形", "的", "矢", "界", "反", "良", "配", "遠", "忘", "完", "且", "都", "降", "婚", "祭", "指", "予", "活",
        "和", "経", "頭", "魚", "実",
    "達", "続", "弱", "短", "辞", "免", "歌", "送", "払", "夫", "変", "食", "動", "泉", "非", "代", "記", "映", "医", "洋",
        "橋", "現", "地", "結", "伝",
    "令", "尺", "平", "度", "際", "貸", "味", "野", "広", "石", "漢", "別", "園", "皆", "即", "店", "院", "登", "原", "晩",
        "絡", "集", "式", "通", "昨", "束", "特", "真", "局", "表",
    "固", "冷", "昔", "究", "薬", "線", "顔", "族", "教", "丙", "宿", "試", "更", "系", "去", "鼻", "亜", "接", "説", "作",
        "節", "則", "今", "永", "氷",
    "法", "場", "願", "科", "弟", "様", "虫", "駅", "商", "悪", "知", "借", "決", "区", "発", "幾", "室", "落", "速", "色",
        "始", "是", "直", "病", "共",
    "何", "忙", "遅", "料", "業", "泳", "係", "飲", "黄", "答", "旅", "皿", "治", "与", "昼", "産", "建", "妹", "池", "制",
        "運", "機", "強", "光", "難", "社", "笑", "験", "史", "研",
    "階", "点", "側", "官", "羽", "温", "寒", "勉", "術", "身", "初", "困", "置", "個", "成", "働", "堂", "組", "起", "争",
        "風", "痛", "吏", "寝", "関",
    "員", "荷", "港", "打", "列", "丸", "館", "飛", "数", "習", "展", "面", "選", "帰", "部", "題", "期", "授", "便", "考",
        "歳", "専", "向", "練", "育",
    "写", "廷", "横", "必", "以", "単", "対", "飯", "号", "卒", "枚", "暑", "乗", "婦", "然", "調", "留", "熱", "使", "残",
        "静", "贈", "菜", "雑", "無", "庭", "相", "長", "礼", "終"
]
